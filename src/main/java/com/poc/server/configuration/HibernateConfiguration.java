package com.poc.server.configuration;
...
@ComponentScan({ "com.poc.server.configuration" })
...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan("com.poc.server.model");
	...
	@Bean
	private HibernateTransactionManager transactionManager(SessionFactory session){
